...
**Contact Form Query** adds a contact form to your WordPress site and allows you to receive new message notifications to your specified email and also to the WordPress Admin Panel. It adds a dashboard widget where the admin can view all the latest messages received in the WordPress dashboard. It supports filtering and searching of messages. Also, you can add extra notes to a message or mark them as answered. To prevent spam entries in the form, this plugin allows you to block messages based on blacklisted keywords so you can input keywords to easily block certain types of spam messages. This plugin also comes with a captcha feature.
